...
if __name__ == "__main__":
    ...
    tile_image_path = '../../dataset/Dermofit/tile_image/'
    tile_label_path = '../../dataset/Dermofit/tile_label/'
    ...
    dataloader = build_dataloader(
        ...
        transform_train_img, transform_train_label, transform_val, transform_test)
